...
func TestInputService1ProtocolTestURIParameterOnlyWithNoLocationNameCase1(t *testing.T) {
	...
	// assert URL
	utilassert.AssertURL(t, "https://test/2014-01-01/jobsByPipeline/foo", r.URL.String())
...
func TestInputService2ProtocolTestURIParameterOnlyWithLocationNameCase1(t *testing.T) {
	...
	// assert URL
	utilassert.AssertURL(t, "https://test/2014-01-01/jobsByPipeline/bar", r.URL.String())
...
func TestInputService3ProtocolTestStringToStringMapsInQuerystringCase1(t *testing.T) {
	...
	// assert URL
	utilassert.AssertURL(t, "https://test/2014-01-01/jobsByPipeline/foo?bar=baz&fizz=buzz", r.URL.String())
...
func TestInputService4ProtocolTestStringToStringListMapsInQuerystringCase1(t *testing.T) {
	...
	// assert URL
	utilassert.AssertURL(t, "https://test/2014-01-01/jobsByPipeline/id?foo=bar&foo=baz&fizz=buzz&fizz=pop", r.URL.String())
...
func TestInputService5ProtocolTestURIParameterAndQuerystringParamsCase1(t *testing.T) {
	...
	// assert URL
	utilassert.AssertURL(t, "https://test/2014-01-01/jobsByPipeline/foo?Ascending=true&PageToken=bar", r.URL.String())
...
func TestInputService8ProtocolTestStreamingPayloadCase1(t *testing.T) {
	...
	// assert URL
	utilassert.AssertURL(t, "https://test/2014-01-01/vaults/name/archives", r.URL.String())
...
func TestInputService12ProtocolTestOmitsNullQueryParamsButSerializesEmptyStringsCase1(t *testing.T) {
	...
	// assert URL
	utilassert.AssertURL(t, "https://test/path", r.URL.String())
...
func TestInputService12ProtocolTestOmitsNullQueryParamsButSerializesEmptyStringsCase2(t *testing.T) {
	...
	// assert URL
	utilassert.AssertURL(t, "https://test/path?abc=mno&param-name=", r.URL.String())
