...
// deleted snapshots. When using Recycle Bin, if your snapshots are deleted,
// they are retained in the Recycle Bin for a time period that you specify.
//
...
// you use any other snapshot in your account. If the retention period expires
// and the snapshot is not restored, the snapshot is permanently deleted from
// the Recycle Bin and is no longer available for recovery. For more information
// about Recycle Bin, see Recycle Bin (https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/snapshot-recycle-bin.html)
