...
//
// See https://docs.aws.amazon.com/sdk-for-go/api/service/wafregional/
// for information on using this package.
//
// Using the Client
//
// To use the WAFRegional client for AWS WAF Regional you will
...
//
//   result, err := svc.AssociateWebACL(params)
//   if err != nil {
...
//   }
//
//   fmt.Println("AssociateWebACL result:")
//   fmt.Println(result)
//
...
//
//   result, err := svc.AssociateWebACLWithContext(ctx, params)
package wafregional
