...
// QLDB provides the API operation methods for making requests to
// Amazon QLDB. See this package's package overview docs
// for details on the service.
//
// QLDB methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *QLDB {
	svc := &QLDB{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a QLDB operation and runs any
