...
type GetPartitionsInput struct {
	...
	//    * decimal
	//
	// If an invalid type is encountered, a PredicateConstructionException (https://code.amazon.com/packages/DaylightService/blobs/5820762977ffbdd59f23f4cf349e47189632202f/--/src/com/amazonaws/daylight/core/storage/parsers/query/parser/PredicateFactoryProvider.java#L37)
	// is thrown.
	//
...
type PutResourcePolicyInput struct {
	...
	// If a value of MUST_EXIST is used here, the call will fail unless a policy
	// has already been set. If a value of NOT_Exist is used, the call will fail
	// if a policy has already been set. If a value of NONE or a null value is used,
