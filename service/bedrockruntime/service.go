...
// BedrockRuntime provides the API operation methods for making requests to
// Amazon Bedrock Runtime. See this package's package overview docs
// for details on the service.
//
// BedrockRuntime methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *BedrockRuntime {
	svc := &BedrockRuntime{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a BedrockRuntime operation and runs any
// custom request initialization.
func (c *BedrockRuntime) newRequest(op *request.Operation, params, data interface{}) *request.Request {
