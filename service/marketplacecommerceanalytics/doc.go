...
//
// See https://docs.aws.amazon.com/sdk-for-go/api/service/marketplacecommerceanalytics/
// for information on using this package.
//
// Using the Client
//
// To use the MarketplaceCommerceAnalytics client for AWS Marketplace Commerce Analytics you will
...
//
//   result, err := svc.GenerateDataSet(params)
//   if err != nil {
...
//   }
//
//   fmt.Println("GenerateDataSet result:")
//   fmt.Println(result)
//
...
//
//   result, err := svc.GenerateDataSetWithContext(ctx, params)
