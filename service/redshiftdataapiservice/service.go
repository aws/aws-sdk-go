...
// RedshiftDataAPIService provides the API operation methods for making requests to
// Redshift Data API Service. See this package's package overview docs
// for details on the service.
//
// RedshiftDataAPIService methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the RedshiftDataAPIService client with a session.
...
// newRequest creates a new request for a RedshiftDataAPIService operation and runs any
// custom request initialization.
func (c *RedshiftDataAPIService) newRequest(op *request.Operation, params, data interface{}) *request.Request {
