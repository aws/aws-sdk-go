...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		...
		"RegisterClient":           ExecuteRegisterClient,
		"StartDeviceAuthorization": ExecuteStartDeviceAuthorization,
	}
)
...
func ExecuteCreateToken(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*SSOOIDC)
	if !ok {
...
// ExecuteRegisterClient is Blink's code
func ExecuteRegisterClient(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*SSOOIDC)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
...
// ExecuteStartDeviceAuthorization is Blink's code
func ExecuteStartDeviceAuthorization(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*SSOOIDC)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
