...
type Bucket struct {
	...
	CreationDate *time.Time `type:"timestamp" defaultTimestampFormat:"iso8601"`
...
type CopyObjectInput struct {
	...
	CopySourceIfModifiedSince *time.Time `location:"header" locationName:"x-amz-copy-source-if-modified-since" type:"timestamp" defaultTimestampFormat:"iso8601"`
	...
	CopySourceIfUnmodifiedSince *time.Time `location:"header" locationName:"x-amz-copy-source-if-unmodified-since" type:"timestamp" defaultTimestampFormat:"iso8601"`
	...
	Expires *time.Time `location:"header" locationName:"Expires" type:"timestamp" defaultTimestampFormat:"iso8601"`
...
type CopyObjectResult struct {
	...
	LastModified *time.Time `type:"timestamp" defaultTimestampFormat:"iso8601"`
}
...
type CreateMultipartUploadOutput struct {
	...
	AbortDate *time.Time `location:"header" locationName:"x-amz-abort-date" type:"timestamp" defaultTimestampFormat:"iso8601"`
...
type GetObjectInput struct {
	...
	IfModifiedSince *time.Time `location:"header" locationName:"If-Modified-Since" type:"timestamp" defaultTimestampFormat:"iso8601"`
	...
	// otherwise return a 412 (precondition failed).
	IfUnmodifiedSince *time.Time `location:"header" locationName:"If-Unmodified-Since" type:"timestamp" defaultTimestampFormat:"iso8601"`
	...
	ResponseExpires *time.Time `location:"querystring" locationName:"response-expires" type:"timestamp" defaultTimestampFormat:"iso8601"`
...
type GetObjectOutput struct {
	...
	LastModified *time.Time `location:"header" locationName:"Last-Modified" type:"timestamp" defaultTimestampFormat:"iso8601"`
...
type MultipartUpload struct {
	...
	Initiated *time.Time `type:"timestamp" defaultTimestampFormat:"iso8601"`
