...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		"StartMedicalStreamTranscription": ExecuteStartMedicalStreamTranscription,
		"StartStreamTranscription":        ExecuteStartStreamTranscription,
	}
)
...
// ExecuteStartMedicalStreamTranscription is Blink's code
func ExecuteStartMedicalStreamTranscription(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*TranscribeStreamingService)
	if !ok {
...
// ExecuteStartStreamTranscription is Blink's code
func ExecuteStartStreamTranscription(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*TranscribeStreamingService)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
