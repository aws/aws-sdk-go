...
//
// See https://docs.aws.amazon.com/sdk-for-go/api/service/mturk/
// for information on using this package.
//
// Using the Client
//
// To use the MTurk client for Amazon Mechanical Turk you will
...
//
//   result, err := svc.AcceptQualificationRequest(params)
//   if err != nil {
...
//   }
//
//   fmt.Println("AcceptQualificationRequest result:")
//   fmt.Println(result)
//
...
//
//   result, err := svc.AcceptQualificationRequestWithContext(ctx, params)
package mturk
