...
type CreatePresignedPortalUrlInput struct {
	...
	SessionDurationSeconds *int64 `locationName:"sessionDurationSeconds" min:"900" type:"integer"`
...
// SetState sets the State field's value.
func (s *CreatePresignedPortalUrlInput) SetState(v string) *CreatePresignedPortalUrlInput {
	s.State = &v
	return s
}
