...
//
// See https://docs.aws.amazon.com/sdk-for-go/api/service/costandusagereportservice/
// for information on using this package.
//
// Using the Client
//
// To use the CostandUsageReportService client for AWS Cost and Usage Report Service you will
