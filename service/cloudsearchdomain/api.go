...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		...
		"UploadDocuments": ExecuteUploadDocuments,
	}
)
...
// ExecuteSearch is Blink's code
func ExecuteSearch(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*CloudSearchDomain)
	if !ok {
...
// ExecuteSuggest is Blink's code
func ExecuteSuggest(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*CloudSearchDomain)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
...
// ExecuteUploadDocuments is Blink's code
func ExecuteUploadDocuments(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*CloudSearchDomain)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
