...
// LexRuntimeV2 provides the API operation methods for making requests to
// Amazon Lex Runtime V2. See this package's package overview docs
// for details on the service.
//
// LexRuntimeV2 methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *LexRuntimeV2 {
	svc := &LexRuntimeV2{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a LexRuntimeV2 operation and runs any
// custom request initialization.
func (c *LexRuntimeV2) newRequest(op *request.Operation, params, data interface{}) *request.Request {
