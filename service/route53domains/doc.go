...
//
// See https://docs.aws.amazon.com/sdk-for-go/api/service/route53domains/
// for information on using this package.
//
// Using the Client
//
// To use the Route53Domains client for Amazon Route 53 Domains you will
...
//
//   result, err := svc.CheckDomainAvailability(params)
//   if err != nil {
...
//   }
//
//   fmt.Println("CheckDomainAvailability result:")
//   fmt.Println(result)
//
...
//
//   result, err := svc.CheckDomainAvailabilityWithContext(ctx, params)
