...
// ExecuteGetMedia is Blink's code
func ExecuteGetMedia(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*KinesisVideoMedia)
	if !ok {
	...
	req, out := svc.GetMediaRequest(&input)
