...
type LogConfiguration struct {
	...
	// container agent project that is available on GitHub (https://github.com/EMCECS/amazon-ecs-agent)
...
type VersionInfo struct {
	...
	//  (https://github.com/EMCECS/amazon-ecs-agent/commits/master) GitHub repository.
