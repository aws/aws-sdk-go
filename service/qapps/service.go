...
// QApps provides the API operation methods for making requests to
// QApps. See this package's package overview docs
// for details on the service.
//
// QApps methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *QApps {
	svc := &QApps{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a QApps operation and runs any
// custom request initialization.
func (c *QApps) newRequest(op *request.Operation, params, data interface{}) *request.Request {
