...
// QConnect provides the API operation methods for making requests to
// Amazon Q Connect. See this package's package overview docs
// for details on the service.
//
// QConnect methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*aws.Config) *QConnect {
	...
	if c.SigningNameDerived || len(c.SigningName) == 0 {
		c.SigningName = "wisdom"
	}
	return newClient(*c.Config, c.Handlers, c.PartitionID, c.Endpoint, c.SigningRegion, c.SigningName, c.ResolvedRegion)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *QConnect {
	svc := &QConnect{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a QConnect operation and runs any
// custom request initialization.
func (c *QConnect) newRequest(op *request.Operation, params, data interface{}) *request.Request {
