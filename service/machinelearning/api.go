...
type CreateMLModelInput struct {
	...
	// to not use L1 normalization. This parameter can't be used when L2 is specified.
	...
	//
	//    The value is a double that ranges from 0 to MAX_DOUBLE. The default is
	// to not use L2 normalization. This parameter can't be used when L1 is specified.
	// Use this parameter sparingly.
...
type RDSDataSpec struct {
	...
	// each row of data a pseudo-random number between 0 and 100, and then selects
	...
	// sort order, which would otherwise result in training and evaluation datasources
