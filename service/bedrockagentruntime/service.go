...
// BedrockAgentRuntime provides the API operation methods for making requests to
// Agents for Amazon Bedrock Runtime. See this package's package overview docs
// for details on the service.
//
// BedrockAgentRuntime methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*aws.Config) *BedrockAgentRuntime {
	...
	if c.SigningNameDerived || len(c.SigningName) == 0 {
		c.SigningName = "bedrock"
	}
	return newClient(*c.Config, c.Handlers, c.PartitionID, c.Endpoint, c.SigningRegion, c.SigningName, c.ResolvedRegion)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *BedrockAgentRuntime {
...
// newRequest creates a new request for a BedrockAgentRuntime operation and runs any
// custom request initialization.
func (c *BedrockAgentRuntime) newRequest(op *request.Operation, params, data interface{}) *request.Request {
