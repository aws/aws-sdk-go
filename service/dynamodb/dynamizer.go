...
func dynamizeStruct(in interface{}) map[string]AttributeValue {
...
func dynamizeMap(in interface{}) map[string]AttributeValue {
...
func dynamize(in interface{}) AttributeValue {
	a := AttributeValue{}
...
func undynamize(a AttributeValue) interface{} {
	if a.S != nil {
		return *a.S
	}
