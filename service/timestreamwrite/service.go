...
// TimestreamWrite provides the API operation methods for making requests to
// Amazon Timestream Write. See this package's package overview docs
// for details on the service.
//
// TimestreamWrite methods are safe to use concurrently. It is not safe to
...
// newRequest creates a new request for a TimestreamWrite operation and runs any
// custom request initialization.
func (c *TimestreamWrite) newRequest(op *request.Operation, params, data interface{}) *request.Request {
