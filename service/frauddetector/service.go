...
// FraudDetector provides the API operation methods for making requests to
// Amazon Fraud Detector. See this package's package overview docs
// for details on the service.
//
// FraudDetector methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *FraudDetector {
	svc := &FraudDetector{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a FraudDetector operation and runs any
// custom request initialization.
func (c *FraudDetector) newRequest(op *request.Operation, params, data interface{}) *request.Request {
