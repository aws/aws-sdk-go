...
type RestoreWorkspaceInput struct {
	...
	// Indicates whether to create snapshots of the root volume and user volume
	// before restoring the WorkSpace.
	SnapshotCurrentVolumes *bool `type:"boolean"`
...
// SetSnapshotCurrentVolumes sets the SnapshotCurrentVolumes field's value.
func (s *RestoreWorkspaceInput) SetSnapshotCurrentVolumes(v bool) *RestoreWorkspaceInput {
	s.SnapshotCurrentVolumes = &v
	return s
}
