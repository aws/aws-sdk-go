...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		"ListRealtimeContactAnalysisSegments": ExecuteListRealtimeContactAnalysisSegments,
	}
)
...
// ExecuteListRealtimeContactAnalysisSegments is Blink's code
func ExecuteListRealtimeContactAnalysisSegments(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*ConnectContactLens)
	if !ok {
