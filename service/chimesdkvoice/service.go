...
// ChimeSDKVoice provides the API operation methods for making requests to
// Amazon Chime SDK Voice. See this package's package overview docs
// for details on the service.
//
// ChimeSDKVoice methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *ChimeSDKVoice {
	svc := &ChimeSDKVoice{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ChimeSDKVoice operation and runs any
// custom request initialization.
func (c *ChimeSDKVoice) newRequest(op *request.Operation, params, data interface{}) *request.Request {
