...
// Account provides the API operation methods for making requests to
// AWS Account. See this package's package overview docs
// for details on the service.
//
// Account methods are safe to use concurrently. It is not safe to
...
// newRequest creates a new request for a Account operation and runs any
// custom request initialization.
func (c *Account) newRequest(op *request.Operation, params, data interface{}) *request.Request {
