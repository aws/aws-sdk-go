...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		"CreateHomeRegionControl":    ExecuteCreateHomeRegionControl,
		"DescribeHomeRegionControls": ExecuteDescribeHomeRegionControls,
		"GetHomeRegion":              ExecuteGetHomeRegion,
	}
)
...
// ExecuteCreateHomeRegionControl is Blink's code
func ExecuteCreateHomeRegionControl(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*MigrationHubConfig)
	if !ok {
	...
	req, out := svc.CreateHomeRegionControlRequest(input)
...
// ExecuteDescribeHomeRegionControls is Blink's code
func ExecuteDescribeHomeRegionControls(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*MigrationHubConfig)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
	...
	req, out := svc.DescribeHomeRegionControlsRequest(input)
	if err := req.Send(); err != nil {
		return nil, err
	}
...
// ExecuteGetHomeRegion is Blink's code
func ExecuteGetHomeRegion(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*MigrationHubConfig)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
	...
	req, out := svc.GetHomeRegionRequest(input)
	if err := req.Send(); err != nil {
		return nil, err
	}
