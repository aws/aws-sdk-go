...
// ExecuteSendCommand is Blink's code
func ExecuteSendCommand(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*QLDBSession)
	if !ok {
	...
	req, out := svc.SendCommandRequest(input)
