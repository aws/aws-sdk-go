...
// API Gateway REST API, Application Load Balancer, AppSync GraphQL API, or
// Amazon Cognito user pool. WAF also lets you control access to your content,
// to protect the Amazon Web Services resource that WAF is monitoring. Based
// on conditions that you specify, such as the IP addresses that requests originate
// from or the values of query strings, the protected resource responds to requests
