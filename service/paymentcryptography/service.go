...
// PaymentCryptography provides the API operation methods for making requests to
// Payment Cryptography Control Plane. See this package's package overview docs
// for details on the service.
//
// PaymentCryptography methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *PaymentCryptography {
	svc := &PaymentCryptography{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a PaymentCryptography operation and runs any
// custom request initialization.
func (c *PaymentCryptography) newRequest(op *request.Operation, params, data interface{}) *request.Request {
