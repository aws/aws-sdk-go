...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		"SendSSHPublicKey":              ExecuteSendSSHPublicKey,
		"SendSerialConsoleSSHPublicKey": ExecuteSendSerialConsoleSSHPublicKey,
	}
)
...
// ExecuteSendSSHPublicKey is Blink's code
func ExecuteSendSSHPublicKey(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*EC2InstanceConnect)
	if !ok {
...
// ExecuteSendSerialConsoleSSHPublicKey is Blink's code
func ExecuteSendSerialConsoleSSHPublicKey(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*EC2InstanceConnect)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
