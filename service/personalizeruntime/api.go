...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		"GetPersonalizedRanking": ExecuteGetPersonalizedRanking,
		"GetRecommendations":     ExecuteGetRecommendations,
	}
)
...
// ExecuteGetPersonalizedRanking is Blink's code
func ExecuteGetPersonalizedRanking(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*PersonalizeRuntime)
	if !ok {
	...
	req, out := svc.GetPersonalizedRankingRequest(input)
...
// ExecuteGetRecommendations is Blink's code
func ExecuteGetRecommendations(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*PersonalizeRuntime)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
	...
	req, out := svc.GetRecommendationsRequest(input)
	if err := req.Send(); err != nil {
		return nil, err
	}
