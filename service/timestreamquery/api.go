...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		"CancelQuery":       ExecuteCancelQuery,
...
// ExecuteCancelQuery is Blink's code
func ExecuteCancelQuery(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*TimestreamQuery)
	if !ok {
