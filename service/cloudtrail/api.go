...
type CreateTrailInput struct {
	CloudWatchLogsLogGroupARN  *string `locationName:"CloudWatchLogsLogGroupArn" type:"string" json:",omitempty"`
	CloudWatchLogsRoleARN      *string `locationName:"CloudWatchLogsRoleArn" type:"string" json:",omitempty"`
	...
	SNSTopicName               *string `locationName:"SnsTopicName" type:"string" json:",omitempty"`
...
type DescribeTrailsInput struct {
	TrailNameList []*string `locationName:"trailNameList" type:"list" json:",omitempty"`
...
type DescribeTrailsOutput struct {
	TrailList []*Trail `locationName:"trailList" type:"list" json:",omitempty"`
