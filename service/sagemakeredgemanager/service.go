...
// SagemakerEdgeManager provides the API operation methods for making requests to
// Amazon Sagemaker Edge Manager. See this package's package overview docs
// for details on the service.
//
// SagemakerEdgeManager methods are safe to use concurrently. It is not safe to
...
// newRequest creates a new request for a SagemakerEdgeManager operation and runs any
// custom request initialization.
func (c *SagemakerEdgeManager) newRequest(op *request.Operation, params, data interface{}) *request.Request {
