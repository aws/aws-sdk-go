...
var (
	ActionMap = map[string]func(map[string]interface{}) (map[string]interface{}, error){
		"GetDeviceRegistration": ExecuteGetDeviceRegistration,
		"SendHeartbeat":         ExecuteSendHeartbeat,
	}
)
...
// ExecuteGetDeviceRegistration is Blink's code
func ExecuteGetDeviceRegistration(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*SagemakerEdgeManager)
	if !ok {
	...
	req, out := svc.GetDeviceRegistrationRequest(&input)
...
// ExecuteSendHeartbeat is Blink's code
func ExecuteSendHeartbeat(parameters map[string]interface{}) (map[string]interface{}, error) {
	svc, ok := parameters["_Service"].(*SagemakerEdgeManager)
	if !ok {
		return nil, errors.New("failed to get AWS service")
	}
	...
	req, out := svc.SendHeartbeatRequest(&input)
	if err := req.Send(); err != nil {
		return nil, err
	}
