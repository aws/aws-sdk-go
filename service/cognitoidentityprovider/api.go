...
func (c *CognitoIdentityProvider) GetJWKSRequest(input *GetJWKSInput) (req *request.Request, output *GetJWKSOutput) {
	op := &request.Operation{
		Name:       opGetJWKS,
		HTTPMethod: "GET",
		HTTPPath:   "/{userPoolId}/.well-known/jwks.json",
	}
...
func (c *CognitoIdentityProvider) GetJWKS(input *GetJWKSInput) (*GetJWKSOutput, error) {
	req, out := c.GetJWKSRequest(input)
	err := req.Send()
	return out, err
}

const opGetOpenIdConfiguration = "GetOpenIdConfiguration"
...
func (c *CognitoIdentityProvider) GetOpenIdConfigurationRequest(input *GetOpenIdConfigurationInput) (req *request.Request, output *GetOpenIdConfigurationOutput) {
	op := &request.Operation{
		Name:       opGetOpenIdConfiguration,
		HTTPMethod: "GET",
		HTTPPath:   "/{userPoolId}/.well-known/openid-configuration",
	}

	if input == nil {
		input = &GetOpenIdConfigurationInput{}
	}

	req = c.newRequest(op, input, output)
	req.Config.Credentials = credentials.AnonymousCredentials
	output = &GetOpenIdConfigurationOutput{}
	req.Data = output
	return
}
...
func (c *CognitoIdentityProvider) GetOpenIdConfiguration(input *GetOpenIdConfigurationInput) (*GetOpenIdConfigurationOutput, error) {
	req, out := c.GetOpenIdConfigurationRequest(input)
	err := req.Send()
	return out, err
}
...
type GetJWKSInput struct {
	_ struct{} `type:"structure"`

	// The user pool ID for the user pool where you want to get JSON Web keys.
	UserPoolId *string `location:"uri" locationName:"userPoolId" min:"1" type:"string" required:"true"`
}
...
type GetJWKSOutput struct {
	...
	Keys []*KeyType `locationName:"keys" type:"list"`
}
...
type GetOpenIdConfigurationInput struct {
	_ struct{} `type:"structure"`

	// The user pool ID for the user pool where you want to get Open ID configuration
	// information.
	UserPoolId *string `location:"uri" locationName:"userPoolId" min:"1" type:"string" required:"true"`
}
...
// information.
type GetOpenIdConfigurationOutput struct {
	_ struct{} `type:"structure"`

	// The authorization endpoint returned by the server response to get the Open
	// ID configuration information.
	Authorization_endpoint *string `locationName:"authorization_endpoint" min:"1" type:"string"`

	// The token-signing algorithm values supported returned by the server response
	// to get the Open ID configuration information.
	Id_token_signing_alg_values_supported []*string `locationName:"id_token_signing_alg_values_supported" type:"list"`

	// The issuer of the Open ID configuration response.
	Issuer *string `locationName:"issuer" min:"1" type:"string"`

	// The URI of the JSON Web keys in the server response to get Open ID configuration
	// information.
	Jwks_uri *string `locationName:"jwks_uri" min:"1" type:"string"`

	// The response types supported returned by the server response to get the Open
	// ID configuration information.
	Response_types_supported []*string `locationName:"response_types_supported" type:"list"`

	// The subject types supported returned by the server response to get the Open
	// ID configuration information.
	Subject_types_supported []*string `locationName:"subject_types_supported" type:"list"`
}
...
type KeyType struct {
	...
	// A "kty" (Key Type) parameter. For more information, see "kty" (Key Type)
	// Parameter (http://self-issued.info/docs/draft-ietf-jose-json-web-key.html#ktyDef).
	Alg *string `locationName:"alg" type:"string"`

	// An "e" parameter.
	E *string `locationName:"e" type:"string"`
	...
	Kid *string `locationName:"kid" type:"string"`

	// A "kty" key type parameter. For more information, see JSON Web Key (JWK)
	// Format.
	Kty *string `locationName:"kty" type:"string"`

	// An "n" parameter.
	N *string `locationName:"n" type:"string"`

	// A "use" (Public Key Use) parameter. For more information, see "use" (Public
	// Key Use) Parameter (http://self-issued.info/docs/draft-ietf-jose-json-web-key.html#useDef).
	Use *string `locationName:"use" type:"string"`
}
...
// GoString returns the string representation
func (s KeyType) GoString() string {
	return s.String()
}
