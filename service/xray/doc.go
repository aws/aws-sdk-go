...
//
// See https://docs.aws.amazon.com/sdk-for-go/api/service/xray/
// for information on using this package.
//
// Using the Client
//
// To use the XRay client for AWS X-Ray you will
...
//
//   result, err := svc.BatchGetTraces(params)
//   if err != nil {
...
//   }
//
//   fmt.Println("BatchGetTraces result:")
//   fmt.Println(result)
//
...
//
//   result, err := svc.BatchGetTracesWithContext(ctx, params)
package xray
