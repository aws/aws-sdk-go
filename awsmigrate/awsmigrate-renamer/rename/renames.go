...
var renamedPackages = map[string]*packageRenames{
	...
	"github.com/EMCECS/aws-sdk-go/service/autoscaling/autoscalingiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/cloudformation/cloudformationiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/cloudfront/cloudfrontiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/cloudhsm/cloudhsmiface": {
		operations: map[string]string{
			"CreateHAPG":          "CreateHapg",
			"CreateHAPGPages":     "CreateHapgPages",
			"CreateHAPGRequest":   "CreateHapgRequest",
	...
	"github.com/EMCECS/aws-sdk-go/service/cloudsearch/cloudsearchiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/cloudsearchdomain/cloudsearchdomainiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/cloudtrail/cloudtrailiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/cloudwatch/cloudwatchiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/cloudwatchlogs/cloudwatchlogsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/codecommit/codecommitiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/codedeploy/codedeployiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/codepipeline/codepipelineiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/cognitoidentity/cognitoidentityiface": {
		operations: map[string]string{
			"GetID":                                     "GetId",
			"GetIDPages":                                "GetIdPages",
			"GetIDRequest":                              "GetIdRequest",
	...
	"github.com/EMCECS/aws-sdk-go/service/cognitosync/cognitosynciface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/configservice/configserviceiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/datapipeline/datapipelineiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/devicefarm/devicefarmiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/directconnect/directconnectiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/directoryservice/directoryserviceiface": {
		operations: map[string]string{
			"DisableSSO":        "DisableSso",
			"DisableSSOPages":   "DisableSsoPages",
			"DisableSSORequest": "DisableSsoRequest",
	...
	"github.com/EMCECS/aws-sdk-go/service/dynamodbstreams/dynamodbstreamsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/ec2/ec2iface": {
		operations: map[string]string{
			"AcceptVPCPeeringConnection":           "AcceptVpcPeeringConnection",
			"AcceptVPCPeeringConnectionPages":      "AcceptVpcPeeringConnectionPages",
			"AcceptVPCPeeringConnectionRequest":    "AcceptVpcPeeringConnectionRequest",
	...
	"github.com/EMCECS/aws-sdk-go/service/ecs/ecsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/efs/efsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/elasticache/elasticacheiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/elasticbeanstalk/elasticbeanstalkiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/elastictranscoder/elastictranscoderiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/elb/elbiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/emr/emriface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/glacier/glacieriface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/iam/iamiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/kinesis/kinesisiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/kms/kmsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/lambda/lambdaiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/machinelearning/machinelearningiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/mobileanalytics/mobileanalyticsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/opsworks/opsworksiface": {
		operations: map[string]string{
			"AssociateElasticIP":             "AssociateElasticIp",
			"AssociateElasticIPPages":        "AssociateElasticIpPages",
			"AssociateElasticIPRequest":      "AssociateElasticIpRequest",
	...
	"github.com/EMCECS/aws-sdk-go/service/rds/rdsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/redshift/redshiftiface": {
		operations: map[string]string{
			"CreateHSMClientCertificate":           "CreateHsmClientCertificate",
			"CreateHSMClientCertificatePages":      "CreateHsmClientCertificatePages",
			"CreateHSMClientCertificateRequest":    "CreateHsmClientCertificateRequest",
	...
	"github.com/EMCECS/aws-sdk-go/service/route53/route53iface": {
		operations: map[string]string{
			"GetCheckerIPRanges":        "GetCheckerIpRanges",
			"GetCheckerIPRangesPages":   "GetCheckerIpRangesPages",
			"GetCheckerIPRangesRequest": "GetCheckerIpRangesRequest",
	...
	"github.com/EMCECS/aws-sdk-go/service/route53domains/route53domainsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/ses/sesiface": {
		operations: map[string]string{
			"GetIdentityDKIMAttributes":        "GetIdentityDkimAttributes",
			"GetIdentityDKIMAttributesPages":   "GetIdentityDkimAttributesPages",
			"GetIdentityDKIMAttributesRequest": "GetIdentityDkimAttributesRequest",
	...
	"github.com/EMCECS/aws-sdk-go/service/sns/snsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/ssm/ssmiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/storagegateway/storagegatewayiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/sts/stsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/support/supportiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/swf/swfiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/EMCECS/aws-sdk-go/service/workspaces/workspacesiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
