...
func TestSignWithToken(t *testing.T) {
	...
	c := Context{
		Service:     "wobble",
		Region:      "us-east-1",
		Credentials: Creds("accessKeyID", "secretAccessKey", "token"),
	}
	c.sign(req)
	...
	expected := "" +
		"POST /fliff?twimble=boo&flaff=hojo&plum HTTP/1.1\r\n" +
		"Host: wobble.awsamazon.com\r\n" +
		"Authorization: AWS4-HMAC-SHA256 Credential=accessKeyID/20141210/us-east-1/wobble/aws4_request, SignedHeaders=content-type;host;x-amz-content-sha256;x-amz-date;x-amz-security-token;x-amz-target, Signature=b4103b3d3238509b48c6c8322e86b3f1fc32f424aa026089609241c7b184783e\r\n" +
		"Content-Type: text/plain\r\n" +
		"X-Amz-Content-Sha256: 7e5e76a11da3174202305c75bfe0963cf2b1b63d7944851ac3c0b84e88105678\r\n" +
		"X-Amz-Date: 20141210T134008Z\r\n" +
