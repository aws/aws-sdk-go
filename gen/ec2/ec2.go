...
type EC2API interface {
	AcceptVPCPeeringConnection(req *AcceptVPCPeeringConnectionRequest) (resp *AcceptVPCPeeringConnectionResult, err error)
	AllocateAddress(req *AllocateAddressRequest) (resp *AllocateAddressResult, err error)
	AssignPrivateIPAddresses(req *AssignPrivateIPAddressesRequest) (err error)
	AssociateAddress(req *AssociateAddressRequest) (resp *AssociateAddressResult, err error)
	AssociateDHCPOptions(req *AssociateDHCPOptionsRequest) (err error)
	AssociateRouteTable(req *AssociateRouteTableRequest) (resp *AssociateRouteTableResult, err error)
	AttachClassicLinkVPC(req *AttachClassicLinkVPCRequest) (resp *AttachClassicLinkVPCResult, err error)
	AttachInternetGateway(req *AttachInternetGatewayRequest) (err error)
	AttachNetworkInterface(req *AttachNetworkInterfaceRequest) (resp *AttachNetworkInterfaceResult, err error)
	AttachVolume(req *AttachVolumeRequest) (resp *VolumeAttachment, err error)
	AttachVPNGateway(req *AttachVPNGatewayRequest) (resp *AttachVPNGatewayResult, err error)
	AuthorizeSecurityGroupEgress(req *AuthorizeSecurityGroupEgressRequest) (err error)
	AuthorizeSecurityGroupIngress(req *AuthorizeSecurityGroupIngressRequest) (err error)
	BundleInstance(req *BundleInstanceRequest) (resp *BundleInstanceResult, err error)
	CancelBundleTask(req *CancelBundleTaskRequest) (resp *CancelBundleTaskResult, err error)
	CancelConversionTask(req *CancelConversionRequest) (err error)
	CancelExportTask(req *CancelExportTaskRequest) (err error)
	CancelReservedInstancesListing(req *CancelReservedInstancesListingRequest) (resp *CancelReservedInstancesListingResult, err error)
	CancelSpotInstanceRequests(req *CancelSpotInstanceRequestsRequest) (resp *CancelSpotInstanceRequestsResult, err error)
	ConfirmProductInstance(req *ConfirmProductInstanceRequest) (resp *ConfirmProductInstanceResult, err error)
	CopyImage(req *CopyImageRequest) (resp *CopyImageResult, err error)
	CopySnapshot(req *CopySnapshotRequest) (resp *CopySnapshotResult, err error)
	CreateCustomerGateway(req *CreateCustomerGatewayRequest) (resp *CreateCustomerGatewayResult, err error)
	CreateDHCPOptions(req *CreateDHCPOptionsRequest) (resp *CreateDHCPOptionsResult, err error)
	CreateImage(req *CreateImageRequest) (resp *CreateImageResult, err error)
	CreateInstanceExportTask(req *CreateInstanceExportTaskRequest) (resp *CreateInstanceExportTaskResult, err error)
	CreateInternetGateway(req *CreateInternetGatewayRequest) (resp *CreateInternetGatewayResult, err error)
	CreateKeyPair(req *CreateKeyPairRequest) (resp *KeyPair, err error)
	CreateNetworkACL(req *CreateNetworkACLRequest) (resp *CreateNetworkACLResult, err error)
	CreateNetworkACLEntry(req *CreateNetworkACLEntryRequest) (err error)
	CreateNetworkInterface(req *CreateNetworkInterfaceRequest) (resp *CreateNetworkInterfaceResult, err error)
	CreatePlacementGroup(req *CreatePlacementGroupRequest) (err error)
	CreateReservedInstancesListing(req *CreateReservedInstancesListingRequest) (resp *CreateReservedInstancesListingResult, err error)
	CreateRoute(req *CreateRouteRequest) (err error)
	CreateRouteTable(req *CreateRouteTableRequest) (resp *CreateRouteTableResult, err error)
	CreateSecurityGroup(req *CreateSecurityGroupRequest) (resp *CreateSecurityGroupResult, err error)
	CreateSnapshot(req *CreateSnapshotRequest) (resp *Snapshot, err error)
	CreateSpotDatafeedSubscription(req *CreateSpotDatafeedSubscriptionRequest) (resp *CreateSpotDatafeedSubscriptionResult, err error)
	CreateSubnet(req *CreateSubnetRequest) (resp *CreateSubnetResult, err error)
	CreateTags(req *CreateTagsRequest) (err error)
	CreateVolume(req *CreateVolumeRequest) (resp *Volume, err error)
	CreateVPC(req *CreateVPCRequest) (resp *CreateVPCResult, err error)
	CreateVPCPeeringConnection(req *CreateVPCPeeringConnectionRequest) (resp *CreateVPCPeeringConnectionResult, err error)
	CreateVPNConnection(req *CreateVPNConnectionRequest) (resp *CreateVPNConnectionResult, err error)
	CreateVPNConnectionRoute(req *CreateVPNConnectionRouteRequest) (err error)
	CreateVPNGateway(req *CreateVPNGatewayRequest) (resp *CreateVPNGatewayResult, err error)
	DeleteCustomerGateway(req *DeleteCustomerGatewayRequest) (err error)
	DeleteDHCPOptions(req *DeleteDHCPOptionsRequest) (err error)
	DeleteInternetGateway(req *DeleteInternetGatewayRequest) (err error)
	DeleteKeyPair(req *DeleteKeyPairRequest) (err error)
	DeleteNetworkACL(req *DeleteNetworkACLRequest) (err error)
	DeleteNetworkACLEntry(req *DeleteNetworkACLEntryRequest) (err error)
	DeleteNetworkInterface(req *DeleteNetworkInterfaceRequest) (err error)
	DeletePlacementGroup(req *DeletePlacementGroupRequest) (err error)
	DeleteRoute(req *DeleteRouteRequest) (err error)
	DeleteRouteTable(req *DeleteRouteTableRequest) (err error)
	DeleteSecurityGroup(req *DeleteSecurityGroupRequest) (err error)
	DeleteSnapshot(req *DeleteSnapshotRequest) (err error)
	DeleteSpotDatafeedSubscription(req *DeleteSpotDatafeedSubscriptionRequest) (err error)
	DeleteSubnet(req *DeleteSubnetRequest) (err error)
	DeleteTags(req *DeleteTagsRequest) (err error)
	DeleteVolume(req *DeleteVolumeRequest) (err error)
	DeleteVPC(req *DeleteVPCRequest) (err error)
	DeleteVPCPeeringConnection(req *DeleteVPCPeeringConnectionRequest) (resp *DeleteVPCPeeringConnectionResult, err error)
	DeleteVPNConnection(req *DeleteVPNConnectionRequest) (err error)
	DeleteVPNConnectionRoute(req *DeleteVPNConnectionRouteRequest) (err error)
	DeleteVPNGateway(req *DeleteVPNGatewayRequest) (err error)
	DeregisterImage(req *DeregisterImageRequest) (err error)
	DescribeAccountAttributes(req *DescribeAccountAttributesRequest) (resp *DescribeAccountAttributesResult, err error)
	DescribeAddresses(req *DescribeAddressesRequest) (resp *DescribeAddressesResult, err error)
	DescribeAvailabilityZones(req *DescribeAvailabilityZonesRequest) (resp *DescribeAvailabilityZonesResult, err error)
	DescribeBundleTasks(req *DescribeBundleTasksRequest) (resp *DescribeBundleTasksResult, err error)
	DescribeClassicLinkInstances(req *DescribeClassicLinkInstancesRequest) (resp *DescribeClassicLinkInstancesResult, err error)
	DescribeConversionTasks(req *DescribeConversionTasksRequest) (resp *DescribeConversionTasksResult, err error)
	DescribeCustomerGateways(req *DescribeCustomerGatewaysRequest) (resp *DescribeCustomerGatewaysResult, err error)
	DescribeDHCPOptions(req *DescribeDHCPOptionsRequest) (resp *DescribeDHCPOptionsResult, err error)
	DescribeExportTasks(req *DescribeExportTasksRequest) (resp *DescribeExportTasksResult, err error)
	DescribeImageAttribute(req *DescribeImageAttributeRequest) (resp *ImageAttribute, err error)
	DescribeImages(req *DescribeImagesRequest) (resp *DescribeImagesResult, err error)
	DescribeInstanceAttribute(req *DescribeInstanceAttributeRequest) (resp *InstanceAttribute, err error)
	DescribeInstanceStatus(req *DescribeInstanceStatusRequest) (resp *DescribeInstanceStatusResult, err error)
	DescribeInstances(req *DescribeInstancesRequest) (resp *DescribeInstancesResult, err error)
	DescribeInternetGateways(req *DescribeInternetGatewaysRequest) (resp *DescribeInternetGatewaysResult, err error)
	DescribeKeyPairs(req *DescribeKeyPairsRequest) (resp *DescribeKeyPairsResult, err error)
	DescribeNetworkACLs(req *DescribeNetworkACLsRequest) (resp *DescribeNetworkACLsResult, err error)
	DescribeNetworkInterfaceAttribute(req *DescribeNetworkInterfaceAttributeRequest) (resp *DescribeNetworkInterfaceAttributeResult, err error)
	DescribeNetworkInterfaces(req *DescribeNetworkInterfacesRequest) (resp *DescribeNetworkInterfacesResult, err error)
	DescribePlacementGroups(req *DescribePlacementGroupsRequest) (resp *DescribePlacementGroupsResult, err error)
	DescribeRegions(req *DescribeRegionsRequest) (resp *DescribeRegionsResult, err error)
	DescribeReservedInstances(req *DescribeReservedInstancesRequest) (resp *DescribeReservedInstancesResult, err error)
	DescribeReservedInstancesListings(req *DescribeReservedInstancesListingsRequest) (resp *DescribeReservedInstancesListingsResult, err error)
	DescribeReservedInstancesModifications(req *DescribeReservedInstancesModificationsRequest) (resp *DescribeReservedInstancesModificationsResult, err error)
	DescribeReservedInstancesOfferings(req *DescribeReservedInstancesOfferingsRequest) (resp *DescribeReservedInstancesOfferingsResult, err error)
	DescribeRouteTables(req *DescribeRouteTablesRequest) (resp *DescribeRouteTablesResult, err error)
	DescribeSecurityGroups(req *DescribeSecurityGroupsRequest) (resp *DescribeSecurityGroupsResult, err error)
	DescribeSnapshotAttribute(req *DescribeSnapshotAttributeRequest) (resp *DescribeSnapshotAttributeResult, err error)
	DescribeSnapshots(req *DescribeSnapshotsRequest) (resp *DescribeSnapshotsResult, err error)
	DescribeSpotDatafeedSubscription(req *DescribeSpotDatafeedSubscriptionRequest) (resp *DescribeSpotDatafeedSubscriptionResult, err error)
	DescribeSpotInstanceRequests(req *DescribeSpotInstanceRequestsRequest) (resp *DescribeSpotInstanceRequestsResult, err error)
	DescribeSpotPriceHistory(req *DescribeSpotPriceHistoryRequest) (resp *DescribeSpotPriceHistoryResult, err error)
	DescribeSubnets(req *DescribeSubnetsRequest) (resp *DescribeSubnetsResult, err error)
	DescribeTags(req *DescribeTagsRequest) (resp *DescribeTagsResult, err error)
	DescribeVolumeAttribute(req *DescribeVolumeAttributeRequest) (resp *DescribeVolumeAttributeResult, err error)
	DescribeVolumeStatus(req *DescribeVolumeStatusRequest) (resp *DescribeVolumeStatusResult, err error)
	DescribeVolumes(req *DescribeVolumesRequest) (resp *DescribeVolumesResult, err error)
	DescribeVPCAttribute(req *DescribeVPCAttributeRequest) (resp *DescribeVPCAttributeResult, err error)
	DescribeVPCClassicLink(req *DescribeVPCClassicLinkRequest) (resp *DescribeVPCClassicLinkResult, err error)
	DescribeVPCPeeringConnections(req *DescribeVPCPeeringConnectionsRequest) (resp *DescribeVPCPeeringConnectionsResult, err error)
	DescribeVPCs(req *DescribeVPCsRequest) (resp *DescribeVPCsResult, err error)
	DescribeVPNConnections(req *DescribeVPNConnectionsRequest) (resp *DescribeVPNConnectionsResult, err error)
	DescribeVPNGateways(req *DescribeVPNGatewaysRequest) (resp *DescribeVPNGatewaysResult, err error)
	DetachClassicLinkVPC(req *DetachClassicLinkVPCRequest) (resp *DetachClassicLinkVPCResult, err error)
	DetachInternetGateway(req *DetachInternetGatewayRequest) (err error)
	DetachNetworkInterface(req *DetachNetworkInterfaceRequest) (err error)
	DetachVolume(req *DetachVolumeRequest) (resp *VolumeAttachment, err error)
	DetachVPNGateway(req *DetachVPNGatewayRequest) (err error)
	DisableVGWRoutePropagation(req *DisableVGWRoutePropagationRequest) (err error)
	DisableVPCClassicLink(req *DisableVPCClassicLinkRequest) (resp *DisableVPCClassicLinkResult, err error)
	DisassociateAddress(req *DisassociateAddressRequest) (err error)
	DisassociateRouteTable(req *DisassociateRouteTableRequest) (err error)
	EnableVGWRoutePropagation(req *EnableVGWRoutePropagationRequest) (err error)
	EnableVolumeIO(req *EnableVolumeIORequest) (err error)
	EnableVPCClassicLink(req *EnableVPCClassicLinkRequest) (resp *EnableVPCClassicLinkResult, err error)
	GetConsoleOutput(req *GetConsoleOutputRequest) (resp *GetConsoleOutputResult, err error)
	GetPasswordData(req *GetPasswordDataRequest) (resp *GetPasswordDataResult, err error)
	ImportInstance(req *ImportInstanceRequest) (resp *ImportInstanceResult, err error)
	ImportKeyPair(req *ImportKeyPairRequest) (resp *ImportKeyPairResult, err error)
	ImportVolume(req *ImportVolumeRequest) (resp *ImportVolumeResult, err error)
	ModifyImageAttribute(req *ModifyImageAttributeRequest) (err error)
	ModifyInstanceAttribute(req *ModifyInstanceAttributeRequest) (err error)
	ModifyNetworkInterfaceAttribute(req *ModifyNetworkInterfaceAttributeRequest) (err error)
	ModifyReservedInstances(req *ModifyReservedInstancesRequest) (resp *ModifyReservedInstancesResult, err error)
	ModifySnapshotAttribute(req *ModifySnapshotAttributeRequest) (err error)
	ModifySubnetAttribute(req *ModifySubnetAttributeRequest) (err error)
	ModifyVolumeAttribute(req *ModifyVolumeAttributeRequest) (err error)
	ModifyVPCAttribute(req *ModifyVPCAttributeRequest) (err error)
	MonitorInstances(req *MonitorInstancesRequest) (resp *MonitorInstancesResult, err error)
	PurchaseReservedInstancesOffering(req *PurchaseReservedInstancesOfferingRequest) (resp *PurchaseReservedInstancesOfferingResult, err error)
	RebootInstances(req *RebootInstancesRequest) (err error)
	RegisterImage(req *RegisterImageRequest) (resp *RegisterImageResult, err error)
	RejectVPCPeeringConnection(req *RejectVPCPeeringConnectionRequest) (resp *RejectVPCPeeringConnectionResult, err error)
	ReleaseAddress(req *ReleaseAddressRequest) (err error)
	ReplaceNetworkACLAssociation(req *ReplaceNetworkACLAssociationRequest) (resp *ReplaceNetworkACLAssociationResult, err error)
	ReplaceNetworkACLEntry(req *ReplaceNetworkACLEntryRequest) (err error)
	ReplaceRoute(req *ReplaceRouteRequest) (err error)
	ReplaceRouteTableAssociation(req *ReplaceRouteTableAssociationRequest) (resp *ReplaceRouteTableAssociationResult, err error)
	ReportInstanceStatus(req *ReportInstanceStatusRequest) (err error)
	RequestSpotInstances(req *RequestSpotInstancesRequest) (resp *RequestSpotInstancesResult, err error)
	ResetImageAttribute(req *ResetImageAttributeRequest) (err error)
	ResetInstanceAttribute(req *ResetInstanceAttributeRequest) (err error)
	ResetNetworkInterfaceAttribute(req *ResetNetworkInterfaceAttributeRequest) (err error)
	ResetSnapshotAttribute(req *ResetSnapshotAttributeRequest) (err error)
	RevokeSecurityGroupEgress(req *RevokeSecurityGroupEgressRequest) (err error)
	RevokeSecurityGroupIngress(req *RevokeSecurityGroupIngressRequest) (err error)
	RunInstances(req *RunInstancesRequest) (resp *Reservation, err error)
	StartInstances(req *StartInstancesRequest) (resp *StartInstancesResult, err error)
	StopInstances(req *StopInstancesRequest) (resp *StopInstancesResult, err error)
	TerminateInstances(req *TerminateInstancesRequest) (resp *TerminateInstancesResult, err error)
	UnassignPrivateIPAddresses(req *UnassignPrivateIPAddressesRequest) (err error)
	UnmonitorInstances(req *UnmonitorInstancesRequest) (resp *UnmonitorInstancesResult, err error)
}
