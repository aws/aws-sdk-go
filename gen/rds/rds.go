...
type RDSAPI interface {
	AddSourceIdentifierToSubscription(req *AddSourceIdentifierToSubscriptionMessage) (resp *AddSourceIdentifierToSubscriptionResult, err error)
	AddTagsToResource(req *AddTagsToResourceMessage) (err error)
	ApplyPendingMaintenanceAction(req *ApplyPendingMaintenanceActionMessage) (resp *ApplyPendingMaintenanceActionResult, err error)
	AuthorizeDBSecurityGroupIngress(req *AuthorizeDBSecurityGroupIngressMessage) (resp *AuthorizeDBSecurityGroupIngressResult, err error)
	CopyDBParameterGroup(req *CopyDBParameterGroupMessage) (resp *CopyDBParameterGroupResult, err error)
	CopyDBSnapshot(req *CopyDBSnapshotMessage) (resp *CopyDBSnapshotResult, err error)
	CopyOptionGroup(req *CopyOptionGroupMessage) (resp *CopyOptionGroupResult, err error)
	CreateDBInstance(req *CreateDBInstanceMessage) (resp *CreateDBInstanceResult, err error)
	CreateDBInstanceReadReplica(req *CreateDBInstanceReadReplicaMessage) (resp *CreateDBInstanceReadReplicaResult, err error)
	CreateDBParameterGroup(req *CreateDBParameterGroupMessage) (resp *CreateDBParameterGroupResult, err error)
	CreateDBSecurityGroup(req *CreateDBSecurityGroupMessage) (resp *CreateDBSecurityGroupResult, err error)
	CreateDBSnapshot(req *CreateDBSnapshotMessage) (resp *CreateDBSnapshotResult, err error)
	CreateDBSubnetGroup(req *CreateDBSubnetGroupMessage) (resp *CreateDBSubnetGroupResult, err error)
	CreateEventSubscription(req *CreateEventSubscriptionMessage) (resp *CreateEventSubscriptionResult, err error)
	CreateOptionGroup(req *CreateOptionGroupMessage) (resp *CreateOptionGroupResult, err error)
	DeleteDBInstance(req *DeleteDBInstanceMessage) (resp *DeleteDBInstanceResult, err error)
	DeleteDBParameterGroup(req *DeleteDBParameterGroupMessage) (err error)
	DeleteDBSecurityGroup(req *DeleteDBSecurityGroupMessage) (err error)
	DeleteDBSnapshot(req *DeleteDBSnapshotMessage) (resp *DeleteDBSnapshotResult, err error)
	DeleteDBSubnetGroup(req *DeleteDBSubnetGroupMessage) (err error)
	DeleteEventSubscription(req *DeleteEventSubscriptionMessage) (resp *DeleteEventSubscriptionResult, err error)
	DeleteOptionGroup(req *DeleteOptionGroupMessage) (err error)
	DescribeDBEngineVersions(req *DescribeDBEngineVersionsMessage) (resp *DBEngineVersionMessage, err error)
	DescribeDBInstances(req *DescribeDBInstancesMessage) (resp *DBInstanceMessage, err error)
	DescribeDBLogFiles(req *DescribeDBLogFilesMessage) (resp *DescribeDBLogFilesResponse, err error)
	DescribeDBParameterGroups(req *DescribeDBParameterGroupsMessage) (resp *DBParameterGroupsMessage, err error)
	DescribeDBParameters(req *DescribeDBParametersMessage) (resp *DBParameterGroupDetails, err error)
	DescribeDBSecurityGroups(req *DescribeDBSecurityGroupsMessage) (resp *DBSecurityGroupMessage, err error)
	DescribeDBSnapshots(req *DescribeDBSnapshotsMessage) (resp *DBSnapshotMessage, err error)
	DescribeDBSubnetGroups(req *DescribeDBSubnetGroupsMessage) (resp *DBSubnetGroupMessage, err error)
	...
	DescribeOptionGroupOptions(req *DescribeOptionGroupOptionsMessage) (resp *OptionGroupOptionsMessage, err error)
	DescribeOptionGroups(req *DescribeOptionGroupsMessage) (resp *OptionGroups, err error)
	DescribeOrderableDBInstanceOptions(req *DescribeOrderableDBInstanceOptionsMessage) (resp *OrderableDBInstanceOptionsMessage, err error)
	DescribePendingMaintenanceActions(req *DescribePendingMaintenanceActionsMessage) (resp *PendingMaintenanceActionsMessage, err error)
	DescribeReservedDBInstances(req *DescribeReservedDBInstancesMessage) (resp *ReservedDBInstanceMessage, err error)
	DescribeReservedDBInstancesOfferings(req *DescribeReservedDBInstancesOfferingsMessage) (resp *ReservedDBInstancesOfferingMessage, err error)
	DownloadDBLogFilePortion(req *DownloadDBLogFilePortionMessage) (resp *DownloadDBLogFilePortionDetails, err error)
	ListTagsForResource(req *ListTagsForResourceMessage) (resp *TagListMessage, err error)
	ModifyDBInstance(req *ModifyDBInstanceMessage) (resp *ModifyDBInstanceResult, err error)
	ModifyDBParameterGroup(req *ModifyDBParameterGroupMessage) (resp *DBParameterGroupNameMessage, err error)
	ModifyDBSubnetGroup(req *ModifyDBSubnetGroupMessage) (resp *ModifyDBSubnetGroupResult, err error)
	ModifyEventSubscription(req *ModifyEventSubscriptionMessage) (resp *ModifyEventSubscriptionResult, err error)
	ModifyOptionGroup(req *ModifyOptionGroupMessage) (resp *ModifyOptionGroupResult, err error)
	PromoteReadReplica(req *PromoteReadReplicaMessage) (resp *PromoteReadReplicaResult, err error)
	PurchaseReservedDBInstancesOffering(req *PurchaseReservedDBInstancesOfferingMessage) (resp *PurchaseReservedDBInstancesOfferingResult, err error)
	RebootDBInstance(req *RebootDBInstanceMessage) (resp *RebootDBInstanceResult, err error)
	RemoveSourceIdentifierFromSubscription(req *RemoveSourceIdentifierFromSubscriptionMessage) (resp *RemoveSourceIdentifierFromSubscriptionResult, err error)
	RemoveTagsFromResource(req *RemoveTagsFromResourceMessage) (err error)
	ResetDBParameterGroup(req *ResetDBParameterGroupMessage) (resp *DBParameterGroupNameMessage, err error)
	RestoreDBInstanceFromDBSnapshot(req *RestoreDBInstanceFromDBSnapshotMessage) (resp *RestoreDBInstanceFromDBSnapshotResult, err error)
	RestoreDBInstanceToPointInTime(req *RestoreDBInstanceToPointInTimeMessage) (resp *RestoreDBInstanceToPointInTimeResult, err error)
	RevokeDBSecurityGroupIngress(req *RevokeDBSecurityGroupIngressMessage) (resp *RevokeDBSecurityGroupIngressResult, err error)
}
