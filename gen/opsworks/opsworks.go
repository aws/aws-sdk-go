...
type OpsWorksAPI interface {
	AssignInstance(req *AssignInstanceRequest) (err error)
	AssignVolume(req *AssignVolumeRequest) (err error)
	AssociateElasticIP(req *AssociateElasticIPRequest) (err error)
	AttachElasticLoadBalancer(req *AttachElasticLoadBalancerRequest) (err error)
	CloneStack(req *CloneStackRequest) (resp *CloneStackResult, err error)
	CreateApp(req *CreateAppRequest) (resp *CreateAppResult, err error)
	CreateDeployment(req *CreateDeploymentRequest) (resp *CreateDeploymentResult, err error)
	CreateInstance(req *CreateInstanceRequest) (resp *CreateInstanceResult, err error)
	CreateLayer(req *CreateLayerRequest) (resp *CreateLayerResult, err error)
	CreateStack(req *CreateStackRequest) (resp *CreateStackResult, err error)
	CreateUserProfile(req *CreateUserProfileRequest) (resp *CreateUserProfileResult, err error)
	DeleteApp(req *DeleteAppRequest) (err error)
	DeleteInstance(req *DeleteInstanceRequest) (err error)
	DeleteLayer(req *DeleteLayerRequest) (err error)
	DeleteStack(req *DeleteStackRequest) (err error)
	DeleteUserProfile(req *DeleteUserProfileRequest) (err error)
	DeregisterElasticIP(req *DeregisterElasticIPRequest) (err error)
	DeregisterInstance(req *DeregisterInstanceRequest) (err error)
	DeregisterRDSDBInstance(req *DeregisterRDSDBInstanceRequest) (err error)
	DeregisterVolume(req *DeregisterVolumeRequest) (err error)
	DescribeApps(req *DescribeAppsRequest) (resp *DescribeAppsResult, err error)
	DescribeCommands(req *DescribeCommandsRequest) (resp *DescribeCommandsResult, err error)
	DescribeDeployments(req *DescribeDeploymentsRequest) (resp *DescribeDeploymentsResult, err error)
	DescribeElasticIPs(req *DescribeElasticIPsRequest) (resp *DescribeElasticIPsResult, err error)
	DescribeElasticLoadBalancers(req *DescribeElasticLoadBalancersRequest) (resp *DescribeElasticLoadBalancersResult, err error)
	DescribeInstances(req *DescribeInstancesRequest) (resp *DescribeInstancesResult, err error)
	DescribeLayers(req *DescribeLayersRequest) (resp *DescribeLayersResult, err error)
	DescribeLoadBasedAutoScaling(req *DescribeLoadBasedAutoScalingRequest) (resp *DescribeLoadBasedAutoScalingResult, err error)
	DescribeMyUserProfile() (resp *DescribeMyUserProfileResult, err error)
	DescribePermissions(req *DescribePermissionsRequest) (resp *DescribePermissionsResult, err error)
	DescribeRAIDArrays(req *DescribeRAIDArraysRequest) (resp *DescribeRAIDArraysResult, err error)
	DescribeRDSDBInstances(req *DescribeRDSDBInstancesRequest) (resp *DescribeRDSDBInstancesResult, err error)
	DescribeServiceErrors(req *DescribeServiceErrorsRequest) (resp *DescribeServiceErrorsResult, err error)
	DescribeStackProvisioningParameters(req *DescribeStackProvisioningParametersRequest) (resp *DescribeStackProvisioningParametersResult, err error)
	DescribeStackSummary(req *DescribeStackSummaryRequest) (resp *DescribeStackSummaryResult, err error)
	DescribeStacks(req *DescribeStacksRequest) (resp *DescribeStacksResult, err error)
	DescribeTimeBasedAutoScaling(req *DescribeTimeBasedAutoScalingRequest) (resp *DescribeTimeBasedAutoScalingResult, err error)
	DescribeUserProfiles(req *DescribeUserProfilesRequest) (resp *DescribeUserProfilesResult, err error)
	DescribeVolumes(req *DescribeVolumesRequest) (resp *DescribeVolumesResult, err error)
	DetachElasticLoadBalancer(req *DetachElasticLoadBalancerRequest) (err error)
	DisassociateElasticIP(req *DisassociateElasticIPRequest) (err error)
	GetHostnameSuggestion(req *GetHostnameSuggestionRequest) (resp *GetHostnameSuggestionResult, err error)
	RebootInstance(req *RebootInstanceRequest) (err error)
	RegisterElasticIP(req *RegisterElasticIPRequest) (resp *RegisterElasticIPResult, err error)
	RegisterInstance(req *RegisterInstanceRequest) (resp *RegisterInstanceResult, err error)
	RegisterRDSDBInstance(req *RegisterRDSDBInstanceRequest) (err error)
	RegisterVolume(req *RegisterVolumeRequest) (resp *RegisterVolumeResult, err error)
	SetLoadBasedAutoScaling(req *SetLoadBasedAutoScalingRequest) (err error)
	SetPermission(req *SetPermissionRequest) (err error)
	SetTimeBasedAutoScaling(req *SetTimeBasedAutoScalingRequest) (err error)
	StartInstance(req *StartInstanceRequest) (err error)
	StartStack(req *StartStackRequest) (err error)
	StopInstance(req *StopInstanceRequest) (err error)
	StopStack(req *StopStackRequest) (err error)
	UnassignInstance(req *UnassignInstanceRequest) (err error)
	UnassignVolume(req *UnassignVolumeRequest) (err error)
	UpdateApp(req *UpdateAppRequest) (err error)
	UpdateElasticIP(req *UpdateElasticIPRequest) (err error)
	UpdateInstance(req *UpdateInstanceRequest) (err error)
	UpdateLayer(req *UpdateLayerRequest) (err error)
	UpdateMyUserProfile(req *UpdateMyUserProfileRequest) (err error)
	UpdateRDSDBInstance(req *UpdateRDSDBInstanceRequest) (err error)
	UpdateStack(req *UpdateStackRequest) (err error)
	UpdateUserProfile(req *UpdateUserProfileRequest) (err error)
	UpdateVolume(req *UpdateVolumeRequest) (err error)
}
