...
type S3API interface {
	AbortMultipartUpload(req *AbortMultipartUploadRequest) (err error)
	CompleteMultipartUpload(req *CompleteMultipartUploadRequest) (resp *CompleteMultipartUploadOutput, err error)
	CopyObject(req *CopyObjectRequest) (resp *CopyObjectOutput, err error)
	CreateBucket(req *CreateBucketRequest) (resp *CreateBucketOutput, err error)
	CreateMultipartUpload(req *CreateMultipartUploadRequest) (resp *CreateMultipartUploadOutput, err error)
	DeleteBucket(req *DeleteBucketRequest) (err error)
	DeleteBucketCORS(req *DeleteBucketCORSRequest) (err error)
	DeleteBucketLifecycle(req *DeleteBucketLifecycleRequest) (err error)
	DeleteBucketPolicy(req *DeleteBucketPolicyRequest) (err error)
	DeleteBucketTagging(req *DeleteBucketTaggingRequest) (err error)
	DeleteBucketWebsite(req *DeleteBucketWebsiteRequest) (err error)
	DeleteObject(req *DeleteObjectRequest) (resp *DeleteObjectOutput, err error)
	DeleteObjects(req *DeleteObjectsRequest) (resp *DeleteObjectsOutput, err error)
	GetBucketACL(req *GetBucketACLRequest) (resp *GetBucketACLOutput, err error)
	GetBucketCORS(req *GetBucketCORSRequest) (resp *GetBucketCORSOutput, err error)
	GetBucketLifecycle(req *GetBucketLifecycleRequest) (resp *GetBucketLifecycleOutput, err error)
	GetBucketLocation(req *GetBucketLocationRequest) (resp *GetBucketLocationOutput, err error)
	GetBucketLogging(req *GetBucketLoggingRequest) (resp *GetBucketLoggingOutput, err error)
	GetBucketNotification(req *GetBucketNotificationRequest) (resp *GetBucketNotificationOutput, err error)
	GetBucketPolicy(req *GetBucketPolicyRequest) (resp *GetBucketPolicyOutput, err error)
	GetBucketRequestPayment(req *GetBucketRequestPaymentRequest) (resp *GetBucketRequestPaymentOutput, err error)
	GetBucketTagging(req *GetBucketTaggingRequest) (resp *GetBucketTaggingOutput, err error)
	GetBucketVersioning(req *GetBucketVersioningRequest) (resp *GetBucketVersioningOutput, err error)
	GetBucketWebsite(req *GetBucketWebsiteRequest) (resp *GetBucketWebsiteOutput, err error)
	GetObject(req *GetObjectRequest) (resp *GetObjectOutput, err error)
	GetObjectACL(req *GetObjectACLRequest) (resp *GetObjectACLOutput, err error)
	GetObjectTorrent(req *GetObjectTorrentRequest) (resp *GetObjectTorrentOutput, err error)
	HeadBucket(req *HeadBucketRequest) (err error)
	HeadObject(req *HeadObjectRequest) (resp *HeadObjectOutput, err error)
	ListBuckets() (resp *ListBucketsOutput, err error)
	ListMultipartUploads(req *ListMultipartUploadsRequest) (resp *ListMultipartUploadsOutput, err error)
	ListObjectVersions(req *ListObjectVersionsRequest) (resp *ListObjectVersionsOutput, err error)
	ListObjects(req *ListObjectsRequest) (resp *ListObjectsOutput, err error)
	ListParts(req *ListPartsRequest) (resp *ListPartsOutput, err error)
	PutBucketACL(req *PutBucketACLRequest) (err error)
	PutBucketCORS(req *PutBucketCORSRequest) (err error)
	PutBucketLifecycle(req *PutBucketLifecycleRequest) (err error)
	PutBucketLogging(req *PutBucketLoggingRequest) (err error)
	PutBucketNotification(req *PutBucketNotificationRequest) (err error)
	PutBucketPolicy(req *PutBucketPolicyRequest) (err error)
	PutBucketRequestPayment(req *PutBucketRequestPaymentRequest) (err error)
	PutBucketTagging(req *PutBucketTaggingRequest) (err error)
	PutBucketVersioning(req *PutBucketVersioningRequest) (err error)
	PutBucketWebsite(req *PutBucketWebsiteRequest) (err error)
	PutObject(req *PutObjectRequest) (resp *PutObjectOutput, err error)
	PutObjectACL(req *PutObjectACLRequest) (err error)
	RestoreObject(req *RestoreObjectRequest) (err error)
	UploadPart(req *UploadPartRequest) (resp *UploadPartOutput, err error)
	UploadPartCopy(req *UploadPartCopyRequest) (resp *UploadPartCopyOutput, err error)
}
