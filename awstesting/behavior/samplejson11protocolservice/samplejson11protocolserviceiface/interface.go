...
type SampleJson11ProtocolServiceAPI interface {
	...
	KitchenSinkOperation(*samplejson11protocolservice.KitchenSinkOperationInput) (*samplejson11protocolservice.KitchenSinkOperationOutput, error)
	KitchenSinkOperationWithContext(aws.Context, *samplejson11protocolservice.KitchenSinkOperationInput, ...request.Option) (*samplejson11protocolservice.KitchenSinkOperationOutput, error)
	KitchenSinkOperationRequest(*samplejson11protocolservice.KitchenSinkOperationInput) (*request.Request, *samplejson11protocolservice.KitchenSinkOperationOutput)

	OperationWithOptionalInputOutput(*samplejson11protocolservice.OperationWithOptionalInputOutputInput) (*samplejson11protocolservice.OperationWithOptionalInputOutputOutput, error)
	OperationWithOptionalInputOutputWithContext(aws.Context, *samplejson11protocolservice.OperationWithOptionalInputOutputInput, ...request.Option) (*samplejson11protocolservice.OperationWithOptionalInputOutputOutput, error)
	OperationWithOptionalInputOutputRequest(*samplejson11protocolservice.OperationWithOptionalInputOutputInput) (*request.Request, *samplejson11protocolservice.OperationWithOptionalInputOutputOutput)
}
