...
//        fmt.Println(resp)
//    }
func (c *SampleService) EmptyOperationRequest(input *EmptyOperationInput) (req *request.Request, output *EmptyOperationOutput) {
...
// EmptyOperation API operation for AWS Sample Service.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
//
// See the AWS API reference guide for AWS Sample Service's
// API operation EmptyOperation for usage and error information.
func (c *SampleService) EmptyOperation(input *EmptyOperationInput) (*EmptyOperationOutput, error) {
...
func (c *SampleService) EmptyOperationWithContext(ctx aws.Context, input *EmptyOperationInput, opts ...request.Option) (*EmptyOperationOutput, error) {
	req, out := c.EmptyOperationRequest(input)
	req.SetContext(ctx)
