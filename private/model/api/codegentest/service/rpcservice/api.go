...
func (es *EmptyStreamEventStream) eventTypeForEmptyStreamEventStreamInputEvent(eventType string) (eventstreamapi.Unmarshaler, error) {
...
func (es *EmptyStreamEventStream) runOutputStream(r *request.Request) {
	...
	eventReader := eventstreamapi.NewEventReader(decoder,
		...
		es.eventTypeForEmptyStreamEventStreamInputEvent,
	)
...
func (es *GetEventStreamEventStream) eventTypeForGetEventStreamEventStreamInputEvent(eventType string) (eventstreamapi.Unmarshaler, error) {
	if eventType == "initial-response" {
		return es.output, nil
	}
...
func (es *GetEventStreamEventStream) runOutputStream(r *request.Request) {
	...
	eventReader := eventstreamapi.NewEventReader(decoder,
		...
		es.eventTypeForGetEventStreamEventStreamInputEvent,
	)
