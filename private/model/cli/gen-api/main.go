...
func writeExamplesFile(g *generateInfo) {
...
func writeServiceFile(g *generateInfo) {
...
func writeInterfaceFile(g *generateInfo) {
...
func writeAPIFile(g *generateInfo) {
